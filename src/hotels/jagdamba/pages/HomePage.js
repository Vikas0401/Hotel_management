...
// Jagdamba Logo Component
const JagdambaLogo = () => (
    <svg 
        className="jagdamba-logo" 
        viewBox="0 0 200 200" 
    ...
    >
        ...
        {/* Devanagari text जगदंबा (Jagdamba) */}
...
const HomePage = () => {
    ...
    const getHotelDescription = () => {
        if (user?.hotelId === 'matoshree') {
            return {
                title: 'हॉटेल जगदंबामध्ये आपले स्वागत आहे',
                description: 'पारंपारिक आणि स्वागतार्ह वातावरणात अस्सल जगदंबा शाकाहारी पाककृतीचा अनुभव घ्या. आमच्या विशेष थाळीपासून ते पारंपारिक नाश्त्यापर्यंत जसे की वडापाव आणि मिसळपाव, आम्ही शुद्ध शाकाहारी स्वाद देतो जे जगदंबाचे खरे सार दर्शवतात.',
                specialties: [
                    {
                        title: 'पारंपारिक शाकाहारी',
                        color: '#C41E3A',
                        description: 'पारंपारिक पद्धतीने बनवलेल्या शुद्ध शाकाहारी जगदंबा पाककृती'
                    },
                    {
                ...
                menuNote: 'पारंपारिक जगदंबा थाळी, नाश्ता आणि मिठाई यांचा समावेश असलेला आमचा व्यापक शाकाहारी मेनू पहा. थालीपीठपासून पुरणपोळीपर्यंत, आमच्याकडे प्रत्येकासाठी अस्सल चव आहे!'
            };
        } else {
            return {
                title: 'हॉटेल जगदंबामध्ये आपले स्वागत आहे',
                description: 'उबदार आणि स्वागतार्ह वातावरणात अस्सल जगदंबा पाककृतीचा अनुभव घ्या. पारंपारिक वडापावपासून स्वादिष्ट बिर्यानीपर्यंत, आम्ही जगदंबाची सर्वोत्तम चव देतो.',
                specialties: [
                    {
                        title: 'अस्सल चव',
                        color: '#e74c3c',
                        description: 'पिढ्यानपिढ्या चालत आलेल्या पारंपारिक जगदंबा पाककृती'
                    },
                    {
                        title: 'ताजे घटक',
                        color: '#28a745',
                ...
                menuNote: '५०+ पेक्षा जास्त अस्सल जगदंबा पदार्थांचा समावेश असलेला आमचा व्यापक मेनू पहा. रस्त्यावरील लोकप्रिय खाद्यपदार्थांपासून पारंपारिक थाळीपर्यंत, आमच्याकडे प्रत्येकासाठी काहीतरी आहे!'
            };
        }
    };
