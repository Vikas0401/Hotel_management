...
import './styles/ShreeSwamiSamarthTheme.css';
import '../../styles/MarathiFonts.css';

const ShreeSwamiSamarthApp = ({ onLogout }) => {
    const isAuth = isAuthenticated();

    return (
        <div className="app shreeswamisamarth-theme">
...
export default ShreeSwamiSamarthApp;
